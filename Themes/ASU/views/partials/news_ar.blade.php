<section class="section-70 section-md-114 bg-index-body bg-catskill">
          <div class="shell">
            <h2 class="home-headings-custom text-bold view-animate fadeInUpSmall delay-06"><span class="first-word">أخر  </span>الأخبار </h2>
            ...
            <div class=" view-animate fadeInUpSmall"><a class="btn btn-ellipse btn-icon btn-icon-right btn-primary" href="{{URL::route($currentLocale . '.news')}}"><span>مزيد من الاخبار </span></a></div>
          </div>
