<section class="bg-white">
          <div class="shell-wide section-70 section-md-114">
            ...
            <div class="offset-top-50 offset-lg-top-56 view-animate fadeInUpSmall"><a class="btn btn-ellipse btn-icon btn-icon-right btn-primary" href="{{URL::route($currentLocale . '.events')}}"><span>More Events</span></a></div>
          </div>
        </section>